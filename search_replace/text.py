...
REPLACE_REGEX = '(?msi)^.*$'
REPLACE_HEADING = _('In field replacement mode, the specified field is set to the text and all previous values are erased. '
                'After replacement is finished, the text can be changed to upper-case, lower-case, or title-case.')
